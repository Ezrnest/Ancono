...
public abstract class FlexibleMathObject<T> implements MathCalculatorHolder<T>{
	/**
	 * The MathCalculator of this FlexibleMathObject
	 */
	 ...
	 * @param mc
	 */
	protected FlexibleMathObject(MathCalculator<T> mc){
	 ...
	 * method is a core method of {@link FlexibleMathObject}. The subclasses can always changes the return 
	 ...
	 * This method is basically equal to {@link #valueEquals(FlexibleMathObject, Function)} as 
	 ...
	 */
	public abstract boolean valueEquals(FlexibleMathObject<T> obj);
