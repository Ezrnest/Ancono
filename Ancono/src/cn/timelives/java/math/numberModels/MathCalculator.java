...
public interface MathCalculator<T> {
	...
	/**
	 * Exception to throw when the calculator cannot do such calculation to the
	 * number type.
	 * 
	 * @author lyc
	 *
	 */
	public static final class UnsupportedCalculationException extends RuntimeException {
