...
public final class EllipseV<T> extends EHSection<T> implements ClosedCurve<T>{
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.planeAG.ClosedCurve#isInside(cn.timelives.java.math.planeAG.Point)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.planeAG.ClosedCurve#isOutside(cn.timelives.java.math.planeAG.Point)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.planeAG.ClosedCurve#relation()
	 */
	@Override
