...
public final class GeneralConicSection<T> extends ConicSection<T>{
	...
	protected T computeI3(){
		if(inv0==null){
			T A2 = mc.multiplyLong(B, 2l),
					C2 = mc.multiplyLong(D, 2l),
					F2 = mc.multiplyLong(E, 2l);
	...
	/**
	 * @see cn.timelives.java.math.planeAG.curve.ConicSection#normalizeAndTrans()
	 */
	@Override
	...
	/**
	 * @see cn.timelives.java.math.planeAG.curve.ConicSection#toStandardForm()
	 */
	@Override
	...
	/**
	 * @see cn.timelives.java.math.planeAG.curve.ConicSection#toStandardFormAndTrans()
	 */
	@Override
...
//		GeneralConicSection<Double> cs = generalFormula(mc, 4d,null,1d);
//		print(cs.transform(Matrix.valueOf(new double[][]{
//			{0,1d},
//			{1d,0d}
//		})));
//	}
