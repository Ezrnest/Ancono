...
// * @author liyicheng
// */
//public abstract class Vector<T> extends MathObjectExtend<T> implements VectorModel<T,Vector<T>> {
////    /**
...
//
//    protected Vector(int length, MathCalculator<T> mc) {
//        super(mc);
////        this.isRow = isRow;
//        this.size = length;
//    }
...
//    @NotNull
//    @Override
//    public Vector<T> add(@NotNull Vector<T> y) {
//        return Vector.addV(this,y);
//    }
//
//    @NotNull
//    @Override
//    public Vector<T> subtract(@NotNull Vector<T> y) {
//        return AlgebraModel.super.subtract(y);
//    }
//
//    /* (non-Javadoc)
...
//
//    /*
//     * @see cn.ancono.math.algebra.abstractAlgebra.linearAlgebra.Matrix#mapTo(java.util.function.Function, cn.ancono.math.numberModels.api.MathCalculator)
//     */
//    @NotNull
//    @Override
...
//     * vector should be a row-vector or column-vector is necessary.
...
//     */
//    @SafeVarargs
//    public static <T> Vector<T> of(MathCalculator<T> mc,
//                                   T... fs) {
//        @SuppressWarnings("unchecked")
...
//        }
//        return new DVector<>(re, mc);
//    }
//
//    /**
//     * The inversion of {@link #addV(Vector, Vector)}.
//     *
...
//        Vector<T> prev = vs[0];
//        for (int i = 1; i < n; i++) {
//            temp1[i - 1] = prev.multiply(mc.negate(
//                    mc.reciprocal(prev.normSq())));
//
//            Vector<T> vec = vs[i];
//            for (int j = 0; j < i; j++) {
//                temp2[j] = list.get(j).multiply(temp1[j].inner(vec));
//            }
//            temp2[i] = vec;
...
//     */
//    public static <T> Vector<T> of(int length, MathCalculator<T> mc, boolean isRow, IntFunction<T> f) {
//        @SuppressWarnings("unchecked")
//        T[] arr = (T[]) new Object[length];
//        for (int i = 0; i < length; i++) {
...
//                return b;
//            }
//            var t = Vector.subtractV(a, b.multiply(r));
//            a = b;
//            b = t;
//            A = B;
//            B = T;
