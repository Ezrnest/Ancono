...
public final class GeneralConicSection<T> extends ConicSection<T> {
    ...
    /**
     * @see cn.ancono.math.geometry.analytic.plane.curve.ConicSection#normalize()
     */
    @Override
    ...
    /**
     * @see cn.ancono.math.geometry.analytic.plane.curve.ConicSection#normalizeAndTrans()
     */
    @Override
    ...
    /**
     * @see cn.ancono.math.geometry.analytic.plane.curve.ConicSection#toStandardForm()
     */
    @Override
    ...
    /**
     * @see cn.ancono.math.geometry.analytic.plane.curve.ConicSection#toStandardFormAndTrans()
     */
    @Override
