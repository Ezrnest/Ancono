...
import cn.ancono.math.geometry.analytic.planeAG.curve.RectifiableCurve;
...
public final class Circle<T> extends ConicSection<T> implements ClosedCurve<T>, RectifiableCurve<T> {
     ...
     */
    @Override
    public cn.ancono.math.geometry.analytic.planeAG.curve.ConicSection.Type determineType() {
