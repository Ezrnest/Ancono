...
public final class GeneralConicSection<T> extends ConicSection<T> {
    ...
    /**
     * @see cn.ancono.math.geometry.analytic.planeAG.curve.ConicSection#normalize()
     */
    @Override
    ...
    /**
     * @see cn.ancono.math.geometry.analytic.planeAG.curve.ConicSection#normalizeAndTrans()
     */
    @Override
    ...
    /**
     * @see cn.ancono.math.geometry.analytic.planeAG.curve.ConicSection#toStandardForm()
     */
    @Override
    ...
    /**
     * @see cn.ancono.math.geometry.analytic.planeAG.curve.ConicSection#toStandardFormAndTrans()
     */
    @Override
