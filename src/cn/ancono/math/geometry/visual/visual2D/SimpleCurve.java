...
public class SimpleCurve extends BufferedCurve {
    ...
    /*
     * @see cn.ancono.math.geometry.visual.visual2D.DrawableCurve#drawPoint(java.awt.image.BufferedImage, java.awt.Graphics, int, int)
     */
    @Override
    ...
    /*
     * @see cn.ancono.math.visual.DrawableCurve#shouldDraw(int, int)
     */
    @Override
