...
public class ComputeExpression {
    ...
    static class LongNode extends Node {
        ...
        /* (non-Javadoc)
         * @see cn.ancono.math.number_models.ComputeExpression.Node#generateCode(java.lang.String, java.lang.StringBuilder)
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see cn.ancono.math.number_models.ComputeExpression.Node#deepEquals(cn.ancono.math.number_models.ComputeExpression.Node)
         */
        @Override
        public boolean deepEquals(Node x) {
...
//				}
    ...
    static class TEP<T> extends ExprParser {
        ...
        /* (non-Javadoc)
         * @see cn.ancono.math.number_models.ComputeExpression.ExprParser#parse()
         */
        @Override
        ...
        /* (non-Javadoc)
         * @see cn.ancono.math.number_models.ComputeExpression.ExprParser#checkValidConstant(int, int)
         */
        @Override
        int checkValidConstant(int index, int offset) {
    ...
    public static class TypeComputeExpression<T> extends ComputeExpression {
        ...
        /* (non-Javadoc)
         * @see cn.ancono.math.number_models.ComputeExpression#compute(java.lang.Object[])
         */
