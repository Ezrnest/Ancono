...
import static cn.ancono.utilities.Printer.*;
...
public abstract class Node implements Computable, Serializable {
    ...
    public static abstract class ListChildNode extends NodeWithChildren {
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node.NodeWithChildren#remove(cn.ancono.math.numberModels.expression.Node)
         */
        @Override
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node.NodeWithChildren#getChildrenList()
         */
        @Override
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node.NodeWithChildren#getNumberOfChildren()
         */
        @Override
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node.NodeWithChildren#getChildren(int)
         */
        @Override
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node.NodeWithChild#replace(cn.ancono.math.numberModels.expression.Node, cn.ancono.math.numberModels.expression.Node)
         */
        @Override
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node.NodeWithChildren#contains(cn.ancono.math.numberModels.expression.Node)
         */
        @Override
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node.NodeWithChildren#doSort(cn.ancono.math.numberModels.expression.Comparator<Node>)
         */
        @Override
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node#listNode(int)
         */
        @Override
    ...
    public static abstract class SingleNode extends NodeWithChildren {
        ...
        /*
         * @see
         * cn.ancono.math.numberModels.expression.Node.NodeWithChildren#replace(
         * cn.ancono.math.numberModels.expression.Node,
         * cn.ancono.math.numberModels.expression.Node)
         */
        @Override
    ...
    public static abstract class BiNode extends NodeWithChildren {
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node.NodeWithChildren#replace(cn.ancono.math.numberModels.expression.Node, cn.ancono.math.numberModels.expression.Node)
         */
        @Override
        public boolean replace(Node original, Node replacement) {
            if (replacement == null) {
    ...
    public static final class Poly extends Node {
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node#equalNode(cn.ancono.math.numberModels.expression.Node)
         */
        @Override
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node#getType()
         */
        @Override
        public Type getType() {
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node#clone()
         */
        @Override
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node#toString()
         */
        @Override
        public String toString() {
            return p.toString();
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node#listNode(java.io.PrintStream, int)
         */
        @Override
        public void listNode(int level) {
            print_(level, '	', true);
...
//            clone.simIdentifier = simIdentifier;
        ...
        /*
         * @see cn.ancono.math.numberModels.expression.Node.FunctionNode#getFunctionName()
         */
        @Override
        public String getFunctionName() {
            return functionName;
