...
object NodeBuilderScope {
    ...
    fun dfun(fname: String, a: Node, b: Node, sortable: Boolean = false): Node.DFunction = Node.wrapNodeDF(fname, a, b, sortable)
...
inline fun <R> buildNode(builder: NodeBuilderScope.() -> R): R = builder(NodeBuilderScope)
