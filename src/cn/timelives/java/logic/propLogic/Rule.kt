...
import cn.timelives.java.logic.propLogic.FormulaMatcher.Companion.A
import cn.timelives.java.logic.propLogic.FormulaMatcher.Companion.B
import cn.timelives.java.logic.propLogic.FormulaMatcher.Companion.C
import cn.timelives.java.logic.propLogic.FormulaMatcher.Companion.F
import cn.timelives.java.logic.propLogic.FormulaMatcher.Companion.T
...
fun ruleFlatten() : Rule = object : Rule{
    ...
    override fun tryApply(f: Formula): Formula? {
        ...
        return AOFormula(t.isAnd,t.fs.flatMap { if(it is AOFormula && it.isAnd == t.isAnd){
            it.fs
        }else{
            listOf(it)
        }
