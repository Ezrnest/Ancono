...
final class VMatrix<T> extends Matrix<T> {
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.algebra.abstractAlgebra.linearAlgebra.Matrix#getNumber(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.algebra.abstractAlgebra.linearAlgebra.Matrix#replaceColumn(int, cn.timelives.java.math.algebra.abstractAlgebra.linearAlgebra.AbstractVector)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.algebra.abstractAlgebra.linearAlgebra.Matrix#replaceRow(int, cn.timelives.java.math.algebra.abstractAlgebra.linearAlgebra.AbstractVector)
	 */
	@Override
