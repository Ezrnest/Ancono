...
import cn.timelives.java.math.combination.Permutation.Cycle;
import cn.timelives.java.math.combination.Permutation.Transposition;
...
public final class Permutations {
	...
	static class ArrPermutation extends AbstractPermutation {
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation#apply(int)
		 */
		@Override
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation#inverse(int)
		 */
		@Override
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation#inverse()
		 */
		@Override
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation#getArray()
		 */
		@Override
		public int[] getArray() {
			return parr.clone();
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation#apply(java.lang.Object[])
		 */
		@Override
		...
		/*
		 * @see
		 * cn.timelives.java.math.combination.AbstractPermutation#compose(cn.timelives.
		...
		/*
		 * @see
		 * cn.timelives.java.math.combination.AbstractPermutation#andThen(cn.timelives.
		 * java.math.combination.Permutation)
		 */
		@Override
	...
	static class Swap extends AbstractPermutation implements Transposition {
		...
		/*
		 * @see
		 * cn.timelives.java.math.combination.Permutation.ElementaryPermutation#getFirst
		 * ()
		 */
		@Override
		public int getFirst() {
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation.ElementaryPermutation#
		 * getSecond()
		 */
		@Override
		...
		/*
		 * @see cn.timelives.java.math.combination.AbstractPermutation#toString()
		 */
		@Override
	...
	static class Identity extends AbstractPermutation implements Transposition {
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation.ElementaryPermutation#containsElement(int)
		 */
		@Override
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation.ElementaryPermutation#getElements()
		 */
		@Override
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation#apply(boolean[])
		 */
		@Override
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation#apply(double[])
		 */
		@Override
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation#apply(long[])
		 */
		@Override
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation#index()
		 */
		@Override
		public long index() {
			return 0;
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation.ElementaryPermutation#length()
		 */
		@Override
		public int length() {
			return 1;
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation#rank()
		 */
		@Override
		public int rank() {
			return 1;
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation#inverseCount()
		 */
		@Override
	...
	static class Rotate extends AbstractPermutation implements Cycle{
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation.RotationPermutation#getElements()
		 */
		@Override
		public int[] getElements() {
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation.RotationPermutation#containsElement(int)
		 */
		@Override
		public boolean containsElement(int x) {
		...
		/*
		 * @see cn.timelives.java.math.combination.Permutation.RotationPermutation#length()
		 */
		@Override
		public int length() {
	...
	private static final MathCalculator<Permutation> mc = new MathCalculatorAdapter<Permutation>() {
		/*
		 * @see cn.timelives.java.math.combination.Permutations#isEqual(cn.timelives.java.math.combination.Permutation, cn.timelives.java.math.combination.Permutation)
		 */
