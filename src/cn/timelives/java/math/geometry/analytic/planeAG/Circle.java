...
public final class Circle<T> extends ConicSection<T> implements ClosedCurve<T>, RectifiableCurve<T>{
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.geometry.analytic.planeAG.ConicSection#getType()
	 */
	@Override
...
//		}
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.geometry.analytic.planeAG.ClosedCurve#computeLength()
	 */
	@Override
