...
implements Simplifiable<T,ConicSection<T>>,SubstituableCurve<T>{
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.geometry.analytic.planeAG.PlaneCurve#contains(cn.timelives.java.math.geometry.analytic.planeAG.Point)
	 */
	@Override
...
//			throw new ArithmeticException("a = 0");
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.geometry.analytic.planeAG.curve.AbstractPlaneCurve#transform(cn.timelives.java.math.geometry.analytic.planeAG.PAffineTrans)
	 */
	@Override
