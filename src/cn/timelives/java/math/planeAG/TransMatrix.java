...
public final class TransMatrix<T> extends Matrix<T> implements Composable<TransMatrix<T>>{
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.linearAlgebra.Matrix#applyFunction(cn.timelives.java.math.MathFunction)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.linearAlgebra.Matrix#calDet()
	 */
	@Override
	public T calDet() {
	...
	private int rank = -1;
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.linearAlgebra.Matrix#calRank()
	 */
	@Override
	public int calRank() {
		if(rank==-1)
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.linearAlgebra.Matrix#getColumnCount()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.linearAlgebra.Matrix#getRowCount()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.timelives.java.math.linearAlgebra.Matrix#mapTo(java.util.function.Function, cn.timelives.java.math.number_models.MathCalculator)
	 */
	@Override
